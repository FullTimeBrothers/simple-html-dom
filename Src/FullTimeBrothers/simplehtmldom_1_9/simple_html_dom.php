...
defined('MAX_FILE_SIZE') || define('MAX_FILE_SIZE', 9000000000);
...
function curlNormal($url)
{
    $userAgent = 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/87.0.4280.66 Safari/537.36';
    $ch = curl_init($url);
    curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
    curl_setopt($ch,CURLOPT_HTTPHEADER,array("accept:  text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.9",
    ...
    curl_setopt($ch, CURLOPT_TIMEOUT, 100); //Tiempo en segundos
...
{
    $userUUIDArray = [
        "12f812fa-f77c-464e-8e6a-b24e734133e6",
        "ebbc55fd-1aae-4166-b5cd-1f06eda98c6f",
        "6928021b-af99-465c-ad40-c3aba1b3ef7f",
        "fa91573e-e491-4ec6-ad4f-03d96b111158",
        "63a0d8d6-1c91-4af1-9327-1e4371f2c279",
        "fcaf9ff9-bf42-4c10-a0d4-a4708b59eb43",
        "74ef8230-d8e3-435f-b73b-4036eee19491",
        "9950c980-5ed4-402e-bd79-271118935d8e",
        "089d24db-276c-49fb-981d-b2fb50411093",
        "b06cd83e-0d34-4d9f-b4d2-092c87482853",
        "4df8d4ad-ebb4-4ce2-969d-ab331732865b",
        "dbe3fb83-6946-4eba-a5a3-e9f07e85393d",
        "320398ba-3ec0-4b1d-a39a-97801edc364f",
        "49ab4a0f-50d1-46f7-81b6-434c0f89564b",
        "79ab2281-081e-456e-8156-6d7e8267eb6a",
        "94109cd1-0edc-4e71-a81c-0a5d7e62186c",
        "104bf0e2-fed1-464d-b677-6fe80c217b02",


    ];

    $SESSIONArray = [
        "d7c362c6-e20c-49cd-bf34-1ad91cb6cbf5",
        "52cb1626-73b9-407c-ad3f-3a1cb4e75e87",
        "3186ef46-c8d2-4d3f-b4c1-f91cd1dc1e22",
        "a30f8177-a023-40c8-b5da-3d667a3df2d7",
        "22659d02-4588-47e2-ad32-8d9d334b0ec3",
        "ba266847-b339-4d81-ac0c-cb2ebca3cfc0",
        "5b830dd7-24fe-42b8-aaf2-5d3af1407db2",
        "70bc3fc7-51e9-4935-be71-b63da7fd99c8",
        "a68bf844-f102-4e53-aebe-e948bba83582",
        "ee44aa66-cb61-4abc-9b28-8d7057fac8fd",
        "cfb195dc-3836-4fce-8461-d822716d7ee8",
        "6caba5ee-f3ac-44a1-922f-4ec64e13b70b",
        "2fcccfe6-1e7c-4c6d-a515-705800bfee48",
        "59990eef-c7c5-46b4-9000-0d17b639a256",
        "c37f09c1-f512-46d5-86a9-50f5040892fb",
        "a06eb7aa-8ad2-4b45-8e65-d3696477e31d",
        "195609f6-456d-4b6f-b2b1-2b746789974f",

    ];

    $datadomeArray = [
        "SzC9_NvIQP.uhCPNy8B7SVzXj2lWyFeAZS2TALX-OERAi~fyhw-NyQxA-~~W63H2XYXj0yvQYvtZePOCbz74~jeKxESZwG3l3RTXsC1hjz",
        ".1LZDTKcuEgSfpLTNFz.66fI85rq_KBteqVvsTJhNovYPZuaJWMlK7z2aOD~2DeQ3g5RXd5aXWA8bt9qYHWarUOs4Eh_kzPNBnq8.ka7eZ",
        "_c1fRxkPv-BS__~3i4tfhwECRU07DlcJ4MevgD63XKFZ6Ww2gmmbNRVI-2hFQ6AWorprq8nL4Ltl6YTl.-C5o_g1g3jw949qeJ6JoCz3U_",
        "5iQCN5YS5AWvl6OFA88Mb4FtzzVE6w6qJv01VRd71g1quY5iyE8hwIpVJLM0uBudxM.TXlA88ThYw7k-ZvD.f6tEQUSzbzKpVfkjyq2Q.G",
        "BNuGfjc04M6Dmr~RWE5Z2_Uo-S8yJTr5nfv4lNeWzmhwREu10tZIqWxk~GOwQthfTIcNhB5mffv1FqAxqHp9A8nqwMlmUHUTejh4A95qZm",
        "HS.4~DI~BS2YNb1q4B6CdS5nR3zpGOboZxBlk5TozzE3OcLPiXTBw.Q9SK-ytNBnw3Aaul.6AUaDoL1~DpEvw1pspLFk5eJffZfnfLc.D4",
        "Wx80EENn9FdvqGnfrZXe.sk1G..~_G6kJRICnSRR5.ORZf.HT2~CdnJOxLKX6tfDA8aitt_OKfg-2GuT6N~NV2qcsABuOfMXF~PBKUSTw_",
        "Tv4x81QMYvZ1wS_ME~ZCB6kpF_taeo4l_8DsDqlc8grEfW3Ida-Jg78~HSA9huIzLf4kIuC9Pxw7rPs7HTtR_b1Wam5AlYUkR6s5_qQ4j4",
        "7qol3z_6nrsaeaGcC5GWoUmtHMkGm5gR.Rnk5gXMnXFx7InsuPeH9V4u-vlcJik_uhB0ED-Ir2Y0gqi-Wo9XdAAQ3QbYH5N_RVuVK.lApi",
        "VT.zAe8yi3ps3YCfFLQ_LKa_2o.CNNm_6pIMV1zRkDHz3wdwnJyoLJcry6cpEvfpKTG0KgtT0UzY75UNCSaQRIae-j.65weJiRTOEhS0MR",
        "Opv.1Nlm7UzwdON~4_zjR8V-kLlPlho5gZ.Y1jNtX7jA8-.BFck-X-gVhdk_ZJx4TEpH8s.i08USCEyjZRWDWkb8~-HZtVVU~OozjBvEkl",
        "9PTpkRei.LXBMmMXkmQ-ei4OZ7nODqzP53Ia_S81QCaDlb1A3ZYCw0geM3.6nM1f9BdGP5kx58OJtUSMFLw7o2b3oIpliTRO9ONB6hj~QC",
        ".99XPL1dzoe8DGwFmJAXebnqXMysNptUvhrPqi92T1f_DT~ZMMWjd88mAV4qmG1giwUl2Vcn-xryUOPEj5u4T2ajJzYQ55vZL7IKoSSyVB",
        "2eQ-.ZEaKraQzDidF3jADTBCoF2WB8Nzgv88OzkoD~zQ9NTI_winQ1LI4~8wMGfjyXWqf2uOB0jswTZaKx8eOGwByeB.ZtXeHf.YsIr42L",
        "IKEM3Otjaz6.phuPjTMdfqKG~xUSnUDHOJPjHEz3EbxSeiJGwa5ssccSNMXxXhatzoU9wx_45u9m1KxfBEEx_d9R98RdTw2nSvVNRIfc6z",
        "AfZso-M_Xu3oK7O2r1_L.onlDpFuh7utsBnuqbruQTGPQjDb4epC0mMPHPo8Vr8TeL3oY4jbSYIBqAKemIVFjFwOtygrUAweJ6WNjMzr9E",
        "F_k50FwQLmD9l3YoiZ0FV_Mud3.aeLnaG44yBKoUxnexYEVIrYrJEfMWxwr37STOOtP9cFJIfr11DuDd7Gook5k-uQ8Z9ByhbNT_9ZsWri",

    ];


    $numero = rand(0, 16);
    $valor1 = $userUUIDArray[$numero];
    $valor2 = $SESSIONArray[$numero];
    $valor3 = $datadomeArray[$numero];
    ...
    curl_setopt($ch,CURLOPT_HTTPHEADER,array("accept:  text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.9",
        ...
        "accept-language:  es-ES,es;q=0.9,en;q=0.8,fr;q=0.7",
        "cache-control:  max-age=0",
        "Cookie: userUUID=$valor1; SESSION=$valor2; datadome=$valor3"));
    curl_setopt($ch, CURLOPT_FOLLOWLOCATION, 1);
    curl_setopt($ch, CURLOPT_SSL_VERIFYPEER, 0);
    curl_setopt($ch, CURLOPT_SSL_VERIFYHOST, 0);
    curl_setopt($ch, CURLOPT_HTTP_VERSION, CURL_HTTP_VERSION_1_1);
